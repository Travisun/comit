...
function DialogContent({
  ...
  return (
    <DialogPrimitive.Portal>
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md p-1 opacity-70 transition-colors hover:bg-hover hover:opacity-100 focus:outline-none">
          <X className="size-4" />
